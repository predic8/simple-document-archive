...
node {
 unstash 'src'
   ...
   withCredentials([[$class: 'FileBinding', credentialsId: 'kubernetes-ca.pem', variable: 'KUBERNETES_CA'], [$class: 'FileBinding', credentialsId: 'kubernetes-config', variable: 'KUBERNETES_CONFIG'], [$class: 'FileBinding', credentialsId: 'kubernetes-jenkins.pem', variable: 'KUBERNETES_JENKINS'], [$class: 'FileBinding', credentialsId: 'kubernetes-jenkins-key.pem', variable: 'KUBERNETES_JENKINS_KEY']]) {
   ...
   withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'c9f674a1-9ede-4624-9fe2-ff600491e28c', passwordVariable: 'HUB_PASSWORD', usernameVariable: 'HUB_USER']]) {
